...
export default function POS () {
  ...
  if (pay && checkoutList.length > 0) {
    return (
      <Checkout checkoutList={checkoutList} setPay={setPay} setCheckoutList={setCheckoutList} promoCode={_promoCode} />
    )
  }
        ...
        <Card>
          <Grid numItems={1} numItemsSm={2} className='mt-4 gap-4'>
            ...
            <div className='w-full mr-4'>
              ...
              <Button
                onClick={(e) => { navigate('/pos/return') }}
                color='blue' size='xs' variant='secondary' icon={MinusCircleIcon} className='w-full mt-4'
              >Devoluciones
              </Button>
              <TextInput value={_promoCode} onChange={(e) => setPromoCode(e.target.value)} placeholder='Codigo promocional' className='w-full mt-4' />
            </div>
